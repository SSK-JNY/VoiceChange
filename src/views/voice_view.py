...
class AudioView:
    ...
    def __init__(self, root, input_devices, output_devices, gui_settings: Optional[GuiLocalSettings] = None):
        ...
        self.robot_distortion_drive_db_var = tk.StringVar(value=f"{float(getattr(self.gui_settings, 'robot_distortion_drive_db', 0.0)):.0f}")
        self.robot_chorus_mix_var = tk.StringVar(value=f"{float(getattr(self.gui_settings, 'robot_chorus_mix', 0.0)):.2f}")
